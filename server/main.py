...
from routers import auth, participants, competitions, results, leaderboard, teams, enrollments, categories_phases, schedule, finance, organizer_applications, config, system_status, interest_notifications
